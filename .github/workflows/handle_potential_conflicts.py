...
def get_label(pr_num):
    return requests.get(f'https://api.github.com/repos/squardcoinpay/squardcoin/pulls/{pr_num}').json()['head']['label']
...
def main():
    ...
    for conflict in conflictPrs:
        ...
        r = requests.get(f'https://api.github.com/repos/squardcoinpay/squardcoin/pulls/{this_pr_num}')
