Contributing to SquardCoin Core
============================

The SquardCoin Core project operates an open contributor model where anyone is
...
include:
  ...
  - *qt* for changes to squardcoin-qt
...
The following applies to code changes to the SquardCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall SquardCoin
Network Protocol consensus changes.

Whether a pull request is merged into SquardCoin Core rests with the project merge
...
Patches that change SquardCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the SquardCoin consensus, it must have been
...
The review process is normally fairly responsive on the SquardCoin Core repository, however
...
Bitcoin Backports are an incredibly valuable part of SquardCoin's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for SquardCoin](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each SquardCoin Core release.
