...
//! Interface for the src/evo part of a squardcoin node (squardcoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a squardcoin node (squardcoind process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a squardcoin node (squardcoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a squardcoin node (squardcoind process).
...
//! Top-level interface for a squardcoin node (squardcoind process).
class Node
{
public:
    virtual ~Node() {}
