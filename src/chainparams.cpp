 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1744144522, nBits=1e0ffff0, nNonce=936831, vtx=1)
...
{
    const char* pszTimestamp = "US to implement 104 tariff on China as Trump imposed deadline passes";
    const CScript genesisOutputScript = CScript() << ParseHex("04d2cacc446f51ee645f8a101dfca3e0dda5292dc26a29ad391ae42d557576950caaed4976a7340d9dfb92c2ada8acb7384f793432eff55fd5ff56dce907c05898") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000ef8e1fe62630977df54700349200cf2f7d64106b176a581d6817621f6d0"); 
        ...
        genesis = CreateGenesisBlock(1744144522, 936831, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000ef8e1fe62630977df54700349200cf2f7d64106b176a581d6817621f6d0"));
        assert(genesis.hashMerkleRoot == uint256S("0xef8ba869cd095687b1a8b992c9e435b2763ae3f6123f7a03b8a583c4b3c30a27"));
        ...
        vSeeds.clear();
        vSeeds.emplace_back("seed1.squardcoin.com");
        vSeeds.emplace_back("seed2.squardcoin.com");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,63);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,64);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,191);
        // SquardCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // SquardCoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // SquardCoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"SdKkP11rU88moQ8W8w7UKkcTrAFXk7ZP8y"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000ef8e1fe62630977df54700349200cf2f7d64106b176a581d6817621f6d0")},
            }
        };
        ...
        // getchaintxstats 17280 00000ef8e1fe62630977df54700349200cf2f7d64106b176a581d6817621f6d0
        chainTxData = ChainTxData{
                1744144522, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000095e04972ab594f6326ef9ba2a209bfa44f5171985b6b9afd41d4642ac19"); 
        ...
        genesis = CreateGenesisBlock(1744144527UL, 1862306UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000095e04972ab594f6326ef9ba2a209bfa44f5171985b6b9afd41d4642ac19"));
        assert(genesis.hashMerkleRoot == uint256S("0xef8ba869cd095687b1a8b992c9e435b2763ae3f6123f7a03b8a583c4b3c30a27"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,191);
        // Testnet SquardCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet SquardCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet SquardCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"SPx1K4jZj3nHQEAwR9rJTJ6QWVSAzCeDRk"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x0000095e04972ab594f6326ef9ba2a209bfa44f5171985b6b9afd41d4642ac19")},
            }
        };
        ...
        // getchaintxstats 17280 0000095e04972ab594f6326ef9ba2a209bfa44f5171985b6b9afd41d4642ac19
        chainTxData = ChainTxData{
                1744144527, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1744144532, 3, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x60190afd1a7077528e71022c9ca1fa899ebe839ed42fca56b0e40183decf66b7"));
        assert(genesis.hashMerkleRoot == uint256S("0xef8ba869cd095687b1a8b992c9e435b2763ae3f6123f7a03b8a583c4b3c30a27"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x60190afd1a7077528e71022c9ca1fa899ebe839ed42fca56b0e40183decf66b7")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 7S127YCzVJS7kXnMLH4ESHh7BEp2kbPcXwtdVShi1cUFVbS1LXR
        vSporkAddresses = {"Sk7d8Te9ifeJFRVJeKcX8xuAooDuocFTCa"};
        nMinSporkKeys = 1;
        ...
        // Regtest SquardCoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,63);
        // Regtest SquardCoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,64);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,191);
        // Regtest SquardCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest SquardCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest SquardCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
