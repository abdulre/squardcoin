...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a SquardCoin address"));
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a SquardCoin address").arg(strCoinJoinName));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr("&Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and squardcoin: URIs)"));
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed SquardCoin Transaction"));
    ...
    openAction->setStatusTip(tr("Open a squardcoin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible SquardCoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the squardcoin logo
