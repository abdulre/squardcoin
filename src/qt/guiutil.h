...
/** Utility functions used by the SquardCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "squardcoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load squardcoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a squardcoin specific theme is activated (light/dark).*/
