...
UniValue importaddress(const JSONRPCRequest& request)
{
    ...
    "as change, and not show up in many RPCs.\n",
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The SquardCoin address (or hex-encoded script)"},
...

    {
        ...
        if (IsValidDestination(dest)) {
            ...
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid SquardCoin address or script");
        }
    }
    if (fRescan)
    {
...
UniValue dumpprivkey(const JSONRPCRequest& request)
{
    RPCHelpMan{"dumpprivkey",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The squardcoin address for the private key"},
        },
        RPCResult{
...
UniValue dumpwallet(const JSONRPCRequest& request)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by SquardCoin Core %s\n", CLIENT_BUILD);
    ...
    UniValue obj(UniValue::VOBJ);
    obj.pushKV("squardcoinversion", CLIENT_BUILD);
                    ...
                    result.pushKV(
                        ...
                        JSONRPCError(
                            ...
                            strprintf("Rescan failed for key with creation timestamp %d. There was an error reading a "
                                      ...
                                      "caused by pruning or data corruption (see squardcoind log for details) and could "
