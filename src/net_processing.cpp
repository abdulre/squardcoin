 ...
 *  We have 4 times smaller block times in SquardCoin, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        SquardCoin Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // SQRD this code also handles non-TXs (SquardCoin specific messages)
