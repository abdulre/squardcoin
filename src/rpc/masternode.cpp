...
static void masternode_list_help(const JSONRPCRequest& request)
{
    RPCHelpMan{"masternodelist",
        ...
        "  owneraddress   - Print the masternode owner SquardCoin address\n"
        "  payee          - Print the masternode payout SquardCoin address (can be additionally filtered,\n"
        "                   partial match)\n"
        "  pubKeyOperator - Print the masternode operator public key\n"
        "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
        "                   (can be additionally filtered, partial match)\n"
        "  votingaddress  - Print the masternode voting SquardCoin address\n",
        {
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "squardcoin",               "masternode",             &masternode,             {} },
    { "squardcoin",               "masternodelist",         &masternode,             {} },
};
// clang-format on
