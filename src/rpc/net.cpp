...
static UniValue addnode(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{"addnode",
        ...
        RPCResult{RPCResult::Type::NONE, "", ""},
        RPCExamples{
            HelpExampleCli("addnode", "\"192.168.0.6:23532\" \"onetry\"")
    + HelpExampleRpc("addnode", "\"192.168.0.6:23532\", \"onetry\"")
        },
    }.Check(request);
...
static UniValue disconnectnode(const JSONRPCRequest& request)
{
    RPCHelpMan{"disconnectnode",
        ...
        RPCResult{RPCResult::Type::NONE, "", ""},
        RPCExamples{
            HelpExampleCli("disconnectnode", "\"192.168.0.6:23532\"")
    + HelpExampleCli("disconnectnode", "\"\" 1")
    + HelpExampleRpc("disconnectnode", "\"192.168.0.6:23532\"")
                    ...
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::ARR, "addresses", "Only when connected = true",
                            {
                                {RPCResult::Type::OBJ, "", "",
                                {
                                    {RPCResult::Type::STR, "address", "The squardcoin server IP and port we're connected to"},
...
static UniValue addpeeraddress(const JSONRPCRequest& request)
{
    RPCHelpMan{"addpeeraddress",
        ...
        RPCExamples{
            HelpExampleCli("addpeeraddress", "\"1.2.3.4\" 23532")
    + HelpExampleRpc("addpeeraddress", "\"1.2.3.4\", 23532")
        },
    }.Check(request);
