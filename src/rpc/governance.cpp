...
static UniValue gobject_prepare(const JSONRPCRequest& request)
{
    ...
    // This command is dangerous because it consumes 5 SQRD irreversibly.
    // If params are lost, it's very hard to bruteforce them and yet
    // users ignore all instructions on squardcoincentral etc. and do not save them...
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    /* SquardCoin features */
    { "squardcoin",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "squardcoin",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "squardcoin",               "gobject",                &gobject,                {} },
    { "squardcoin",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
