...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
    ...
    + HelpExampleCli("generatetoaddress", "11 \"myaddress\"")
        + "If you are running the SquardCoin Core wallet, you can get a new address to send the newly generated coins to with:\n"
...
static UniValue prioritisetransaction(const JSONRPCRequest& request)
{
    RPCHelpMan{"prioritisetransaction",
        "Accepts the transaction into mined blocks at a higher (or lower) priority\n",
        {
            ...
            {"fee_delta", RPCArg::Type::NUM, RPCArg::Optional::NO, "The fee value (in Squish) to add (or subtract, if negative).\n"
