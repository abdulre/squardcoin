...
// See https://github.com/squardcoinpay/dips/blob/master/dip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
static constexpr std::array<LLMQParams, 14> available_llmqs = {
    ...
    /**
     * llmq_test (SquardCoin Core 0.17) aka llmq_test_v17
     * This quorum is only used for testing
     *
     */
    LLMQParams{
