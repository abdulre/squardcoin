...
BOOST_AUTO_TEST_CASE(caddrdb_read)
{
    ...
    BOOST_CHECK(Lookup("250.7.2.2", addr2, 23532, false));
    BOOST_CHECK(Lookup("250.7.3.3", addr3, 23532, false));
    BOOST_CHECK(Lookup("250.7.3.3"s, addr3, 23532, false));
    BOOST_CHECK(!Lookup("250.7.3.3\0example.com"s, addr3, 23532, false));
