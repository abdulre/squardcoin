...
/* Initialize SquardCoin-specific components after chainstate initialization */
void SquardCoinTestSetup(NodeContext& node);
void SquardCoinTestSetupClose(NodeContext& node);
