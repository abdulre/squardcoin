# Support for Output Descriptors in SquardCoin Core

Since SquardCoin Core v0.17, there is support for Output Descriptors. This is a
...
existing SquardCoin Core wallets, a convenience function `combo` is
...
All RPCs in SquardCoin Core will include the checksum in their output. Only
