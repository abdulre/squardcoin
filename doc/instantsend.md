...
This mechanism has been integrated into Bitcore-Node-SquardCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/squardcoinpay/insight-api-squardcoin#web-socket-api](https://github.com/squardcoinpay/insight-api-squardcoin#web-socket-api)
* API: [https://github.com/squardcoinpay/insight-api-squardcoin#instantsend-transactions](https://github.com/squardcoinpay/insight-api-squardcoin#instantsend-transactions)
