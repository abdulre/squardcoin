# SquardCoin Core version v19.3.0
...
- `wipetxes`: New command for `squardcoin-wallet` that removes all wallet transactions
...
See detailed [set of changes](/compare/v19.2.0...squardcoinpay:v19.3.0).
