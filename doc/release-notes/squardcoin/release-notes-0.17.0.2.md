SquardCoin Core version 0.17.0.2
==========================
...
provided in [DIP-0020](https://github.com/squardcoinpay/dips/blob/master/dip-0020.md).
...
from other quorum members. This allows SquardCoin Platform to obtain required
...
provided in [DIP-0021](https://github.com/squardcoinpay/dips/blob/master/dip-0021.md).

Platform support
----------------
Support for SquardCoin Platform has been expanded through the addition of a new
...
BLS update
----------
SquardCoin Core’s BLS signature library has been updated based on v1.0 of the
Chia BLS library to support migration to a new BLS signature scheme which will
be implemented in a future version of SquardCoin. These changes will be made to
align with standards and improve security.

Network performance improvements
--------------------------------
This version of SquardCoin Core includes multiple optimizations to the network and
p2p message handling code.

We reintroduced [Intra-Quorum Connections](https://github.com/squardcoinpay/dips/blob/master/dip-0006.md#intra-quorum-communication)
...
reliability. Activation of `SPORK_22_PS_MORE_PARTICIPANTS` in SquardCoin v0.16
...
RPC changes
-----------
There are seven new RPC commands which are SquardCoin specific and seven new RPC
...
will be removed in SquardCoin v0.18. Note that the deprecation of wallet accounts
...
SquardCoin users. Bitcoin changes that do not align with SquardCoin’s product needs, such
...
See detailed [set of changes](/compare/v0.16.1.1...squardcoinpay:v0.17.0.2).
