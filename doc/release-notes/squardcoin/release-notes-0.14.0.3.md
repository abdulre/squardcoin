SquardCoin Core version 0.14.0.3
==========================
...
--------------------------------
Version 0.13.0.0 introduced a new database (evodb) which is found in the datadir of SquardCoin Core. It turned
...
Version 0.14.0.0 also introduced a new database (llmq) which is also found in the datadir of SquardCoin Core.
...
---------------------------------------------------
AppNap is disabled now when SquardCoin Core is syncing/reindexing or mixing.
...
--------------------------------------------------
The debug console will now show how many InstantSend locks SquardCoin Core knows about. Please note that this number
...
See detailed [set of changes](/compare/v0.14.0.2...squardcoinpay:v0.14.0.3).
...
- [`5af6ce91d`](/commit/5af6ce91d) Add SquardCoin Core Group codesign certificate (#3027)
