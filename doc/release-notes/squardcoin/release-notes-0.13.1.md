SquardCoin Core version 0.13.1.0
==========================
...
See detailed [set of changes](/compare/v0.13.0.0...squardcoinpay:v0.13.1.0).
...
- [`070ad103f`](/commit/070ad103f) Wait for script checks to finish before messing with txes in SquardCoin-specific way (#2652)
