# Fuzzing SquardCoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing SquardCoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
Every single pull request submitted against the SquardCoin Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make SquardCoin Core more robust.
...
with certain assembly code from SquardCoin Core's code. See [developer notes on sanitizers](/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing SquardCoin Core using afl++

## Quickstart guide

To quickly get started fuzzing SquardCoin Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing SquardCoin Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing SquardCoin Core using [Honggfuzz](https://github.com/google/honggfuzz):
