...
This document provides guidelines for internationalization of the SquardCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `squardcoin_en.ts` remains unchanged.
