...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: SquardCoin's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'SquardCoin', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
