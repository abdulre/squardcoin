...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 SQRD
        ...
        # feeRate of 0.1 SQRD / KB produces a total fee slightly below -maxtxfee (~0.06650000):
        ...
        # feeRate of 10 SQRD / KB produces a total fee well above -maxtxfee
