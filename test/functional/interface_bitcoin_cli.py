...
# The block reward of coinbaseoutput.nValue (500) SQRD/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 500 SQRD/block.
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `squardcoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and squardcoin-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (500 SQRD) to the default wallet.
