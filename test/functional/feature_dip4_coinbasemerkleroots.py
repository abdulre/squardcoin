...
class LLMQCoinbaseCommitmentsTest(SquardCoinTestFramework):
    def set_test_params(self):
        self.set_squardcoin_test_params(4, 3, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as SquardCoinTestFramework doesn't support this atm)
