...
class FullBlockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure squardcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure squardcoind isn't accepting b28
        ...
        #
        # b40 creates 3333 tx's spending the 6-sigop P2SH outputs from b39 for a total of 33531 sigops.
        ...
        # squardcoind doesn't disconnect us for sending a bloated block, but if we subsequently
