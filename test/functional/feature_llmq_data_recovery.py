...
class QuorumDataRecoveryTest(SquardCoinTestFramework):
    def set_test_params(self):
        extra_args = [["-vbparams=testdummy:0:999999999999:10:8:6:5:-1"] for _ in range(9)]
        self.set_squardcoin_test_params(9, 7, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_squardcoin_llmq_test_params(4, 3)
