...
# TestP2PConn: A peer we use to send messages to squardcoind, and store responses.
...
#            "-txindex",
    ...
    # This test actually causes squardcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that squardcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for squardcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # squardcoind will not send blocktxn responses for blocks whose height is
