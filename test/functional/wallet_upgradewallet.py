...
class UpgradeWalletTest(BitcoinTestFramework):
    ...
    def skip_test_if_missing_module(self):
        ...
        raise SkipTest("Test wallet_upgradewallet.py is not adapted for SquardCoin Core yet.")
    ...
    def setup_nodes(self):
        ...
        # adapt squardcoin.conf, because older squardcoind's don't recognize config sections
    ...
    def run_test(self):
        ...
        # Copy the 0.16.3 wallet to the last SquardCoin Core version and open it:
        ...
        self.stop_node(0)
        # Copy the 0.15.2 wallet to the last SquardCoin Core version and open it:
        shutil.rmtree(node_master_wallet_dir)
        os.mkdir(node_master_wallet_dir)
        shutil.copy(
            v15_2_wallet,
