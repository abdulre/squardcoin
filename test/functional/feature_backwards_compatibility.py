...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(4)
        # it expected to fail with error 'DBErrors::TOO_NEW' but SquardCoin Core can open v18 by version 17
        # can be implemented in future if there's any incompatible versions
        #node_v17.assert_start_raises_init_error(["-wallet=w3_v18"], "Error: Error loading w3_v18: Wallet requires newer version of SquardCoin Core")
        #node_v17.assert_start_raises_init_error(["-wallet=w3"], "Error: Error loading w3: Wallet requires newer version of SquardCoin Core")
        self.start_node(4)
