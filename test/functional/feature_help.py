...
"""Verify that starting squardcoind with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start squardcoind with -h for help text")
        ...
        self.log.info("Start squardcoind with -version for version information")
        ...
        self.log.info("Start squardcoindd with -fakearg to make sure it does not start")
