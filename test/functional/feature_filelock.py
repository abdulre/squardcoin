...
class FilelockTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Check that we can't start a second squardcoind instance using the same datadir")
        ...
        if self.is_wallet_compiled():
            ...
            self.log.info("Check that we can't start a second squardcoind instance using the same wallet")
            expected_msg = "Error: SQLiteDatabase: Unable to obtain an exclusive lock on the database, is it being used by another squardcoind?"
