...
"""Test the squardcoin specific ZMQ notification interfaces."""
...
from test_framework.test_framework import SquardCoinTestFramework
...
class SquardCoinZMQTest (SquardCoinTestFramework):
    def set_test_params(self):
        ...
        self.set_squardcoin_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_squardcoin_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that squardcoind has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all squardcoin related ZMQ publisher
