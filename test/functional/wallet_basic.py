...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 210 SQRD from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 SQRD in block rewards plus fees, but
        ...
        # Send 100 SQRD with subtract fee from amount
        ...
        # Sendmany 100 SQRD with subtract fee from amount
        ...
        # Sendmany with explicit fee (SQRD/kB)
        ...
        # This will raise an exception for attempting to get the private key of an invalid SquardCoin address
        assert_raises_rpc_error(-5, "Invalid SquardCoin address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid SquardCoin address
        assert_raises_rpc_error(-5, "Invalid SquardCoin address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid SquardCoin address or script", self.nodes[0].importaddress, "invalid")
        ...
        # send with explicit squardcoin/kb fee
        self.log.info("test explicit fee (sendtoaddress as squardcoin/kb)")
        self.nodes[0].generate(1)
        self.sync_all(self.nodes[0:3])
