...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The SquardCoin Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a SquardCoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The SquardCoin Core developers'
...
Arguments:
    <base_directory> - The base directory of SquardCoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the SquardCoin Core repository.
"""
