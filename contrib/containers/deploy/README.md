...
official/supported Docker Images found at https://hub.docker.com/r/squardcoinpay/squardcoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/squardcoinpay/squardcoind-develop/ when changing the above text**